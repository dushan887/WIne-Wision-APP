...
const PrivacyScreen = React.memo(() => {
  return (
    <ScrollView style={tw`flex-1 bg-${WineVisionColors.carbon.primary}`}>
      <View style={tw`p-6`}>
        ...
        <Text style={tw`text-${WineVisionColors.carbon.muted} text-base leading-6 mb-4`}>
        ...
        <Text style={tw`text-${WineVisionColors.carbon.muted} text-base leading-6`}>

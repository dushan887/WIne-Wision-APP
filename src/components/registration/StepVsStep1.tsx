...
const StepVsStep1: React.FC<StepVsStep1Props> = ({ 
  savedData, 
  onUpdateData, 
  onNext, 
  headerTitle, 
  ...
  const options = [
    { 
      ...
      subtitle: 'CHOOSE SINGLE OPTION',
      details: [
        { text: 'Provide your elementary personal credentials', type: 'COMPULSORY' },
        { text: 'Specify your areas of interest, related to the fair', type: 'COMPULSORY' }
      ]
    },
    { 
      label: 'Company', 
      ...
      subtitle: 'CHOOSE SINGLE OPTION',
      details: [
        { text: 'Participate in B2B Sessions', type: 'COMPULSORY' },
        { text: 'Apply for Wine Vision Hosted Buyers Program', type: 'OPTIONAL' }
      ]
    }
  ];

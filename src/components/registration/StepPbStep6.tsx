...
// Step component for 'wv-pb-step-6' (Company Description)
const StepPbStep6: React.FC<StepPbStep6Props> = ({ savedData, onUpdateData, onNext, headerTitle, headerSubtitle }) => {
      ...
      <View style={tw`mt-0`}>
        ...
        <View style={[
          ...
          <TextInput
            ...
            placeholder="Describe your company, its activities, products, and services..."
